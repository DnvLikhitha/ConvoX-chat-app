      ...
      <div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-[#e6e6e6] p-12 text-black">
        ...
        <div className="relative z-20 flex flex-col gap-4 text-sm text-black/60">
          <p className="text-black/80 font-medium text-lg leading-snug max-w-sm">
            "We built ConvoX because we were tired of messaging apps feeling disconnected and boring. Dive in to see the difference."
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <div onClick={() => toast.info('Password reset coming soon!')} className="text-xs text-[#e6e6e6] hover:text-white hover:underline cursor-pointer font-medium">
                  Forgot password?
                </div>
              </div>
